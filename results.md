...
| Metric | Chance | COLIPRI | Merlin | RAD-DINO |
|---|---|---|---|---|
| **Embedding dim** | — | 768 | 2048 | 768 |
| **Input type** | — | 3D volume | 3D volume | 32 axial slices (mean-pooled) |
| **T1b ARI** (k-means vs week) | 0 | 0.033 | 0.011 | −0.010 |
| **T1b NMI** (k-means vs week) | 0 | 0.047 | 0.017 | 0.013 |
| **T1c Silhouette** (cosine, by week) | 0 | −0.074 | −0.050 | **+0.020** |
| **T1d Δ** (intra − inter cosine sim) | 0 | 0.0003 | 0.0006 | **0.0055** |
| **T2a Accuracy** (4-class week, LOSO) | 0.25 | 0.454 | 0.563 | **0.878** |
| **T2a macro-F1** (4-class week, LOSO) | — | 0.279 | 0.444 | **0.854** |
| **T2b Accuracy** (early vs late, LOSO) | 0.50 | 0.605 | 0.748 | **1.000** |
| **T2b AUC-ROC** (early vs late, LOSO) | 0.50 | 0.683 | 0.852 | **1.000** |
| **T3a** Pairwise temporal ordering | 0.50 | 0.685 | 0.770 | **0.926** |
| **T3b** Subject retrieval Recall@1 | — | 0.018 | **0.044** | 0.013 |
| **T3b** Subject retrieval MRR | — | 0.066 | **0.096** | 0.072 |
| **T3c** Week retrieval mAP@5 | — | 0.659 | 0.692 | **0.844** |
